...
async def help(ctx):
    ...
    embed.set_thumbnail(
        url="https://avatars.mds.yandex.net/i?id=2a00000179f8985e845048ef5412f9930614-5175033-images-thumbs&n=13")
    embed.add_field(name="Список доступных комманд",
                    value="Для просмотра существующих ролей введите - !roles \nДля того, чтобы получить инфаркт от вашей статки введите - !stats",
                    inline=False)
